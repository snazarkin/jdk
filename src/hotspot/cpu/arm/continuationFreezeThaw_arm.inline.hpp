...
inline void FreezeBase::relativize_interpreted_frame_metadata(const frame& f, const frame& hf) {
  ...
  // on ARM, we don't insert padding between the locals and the rest of the frame
  // (see TemplateInterpreterGenerator::generate_normal_entry, and AbstractInterpreter::layout_activation)
  // but we recompute locals "from scratch" to keep the code similar to other platforms.
